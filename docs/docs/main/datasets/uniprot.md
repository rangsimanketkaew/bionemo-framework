...
(~150MB). To load and use the sanity dataset, use the `bionemo.common.data.load.load` function to materialize the sanity
dataset in the BioNeMo cache directory:
